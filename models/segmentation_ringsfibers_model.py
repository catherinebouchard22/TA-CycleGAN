...
class SegmentationRingsFibersModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_fibers', type=float, default=1, help='weight for fibers seg loss')
        return parser
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['S_rings', 'S_fibers']
        # specify the images you want to save/display. The training/test scripts will call <BaseModel.get_current_visuals>
        self.visual_names = ['B', 'seg_B']
    ...
    def forward(self):
        ...
        self.loss_S_rings = self.criterionSEG(self.seg_GT[:,0,:,:], self.seg_B[:,0,:,:])
        self.loss_S_fibers = self.criterionSEG(self.seg_GT[:,1,:,:], self.seg_B[:,1,:,:])
        self.loss_S = (self.loss_S_rings + self.opt.lambda_fibers * self.loss_S_fibers)/2
