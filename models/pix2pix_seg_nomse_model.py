...
class Pix2PixSegNoMSEModel(BaseModel):
    ...
    def forward(self):
        ...
        if not self.opt.isTrain:
            self.visual_name = ['real_A', 'real_B', 'seg_rB', 'seg_fB', 'fake_B']
            #for i in range(50):
                #self.visual_names.append('seg_fB{}'.format(i))
                #self.visual_names.append('fake_B{}'.format(i))
