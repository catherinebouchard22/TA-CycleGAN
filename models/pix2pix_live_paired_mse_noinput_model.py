...
class Pix2PixLivePairedMSENoinputModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_B', 'seg_fB', 'fake_B', 'seg_rB', 'real_A']
        if not self.isTrain:
            self.visual_names = ['real_A', 'real_B', 'seg_fB', 'fake_B', 'seg_rB']
    ...
    def forward(self):
        ...
        if self.isTrain and self.isValid:
